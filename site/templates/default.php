    ...
    <main>
      <article class="flow">
        ...
        <section id="services">
          ...
          <p>If you’re looking for direction, scaling yourself, or have a team needs a change— we tailor talks & custom workshops to support you.</p>
    ...
    <footer class="flow">
      ...
      <details class="colophon">
        ...
        <div class="content">
          ...
          <p>This site is cleaner than 95% of webpages globally, with<br/> 0.03g of CO<sub>2</sub>/view. Rated <strong>A+</strong> by <a href="https://www.websitecarbon.com/website/poetandscribe-com/">Website Carbon</a>.
